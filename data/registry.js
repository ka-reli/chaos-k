...
(function (root) {
  ...
  var EFFECTS = [
    ...
    { id: 'blackletter', aliases: ['готика', 'blackletter', 'gothic', 'фрактура'], css: 'fx-blackletter', moods: ['sacred', 'corrupt', 'eerie'], intensity: 3, scope: 'inline', weight: 0.3, colorBased: false, special: false, reducedMotion: null, desc: 'готический шрифт' },
