...
(function (root) {
  ...
  var EFFECTS = [
    ...
    { id: 'scramble', aliases: ['перемешивание', 'scramble', 'shuffle', 'мешанина'], css: 'fx-scramble', moods: ['chaos', 'fear'], intensity: 6, scope: 'inline', weight: 1.0, colorBased: false, special: false, perLetter: true, reducedMotion: 'disable', desc: 'буквы мешаются и встают на место' },
    ...
    { id: 'scatter', aliases: ['разлёт', 'scatter', 'explode', 'разброс'], css: 'fx-scatter', moods: ['chaos', 'fear'], intensity: 8, scope: 'spatial', weight: 0.3, colorBased: false, special: false, perLetter: true, reducedMotion: 'disable', maxChars: 100, desc: 'слова разбросаны по странице' },
    { id: 'wave', aliases: ['волна', 'wave', 'undulate', 'колышется'], css: 'fx-wave', moods: ['dream', 'sensual', 'calm'], intensity: 6, scope: 'spatial', weight: 1.0, colorBased: false, special: false, perLetter: true, reducedMotion: 'disable', maxChars: 200, desc: 'фраза колышется волной, буква за буквой' },

    { id: 'strobe', aliases: ['строб', 'strobe', 'мигание'], css: 'fx-strobe', moods: ['chaos', 'fear', 'rage'], intensity: 7, scope: 'inline', weight: 0.3, colorBased: false, special: false, reducedMotion: 'disable', desc: 'резкое мигание, как стробоскоп' },
    { id: 'hologram', aliases: ['голограмма', 'hologram', 'проекция'], css: 'fx-hologram', moods: ['cold', 'sacred', 'dream'], intensity: 5, scope: 'inline', weight: 1.0, colorBased: false, special: true, reducedMotion: 'fx-hologram-static', desc: 'голографическая проекция с полосами' },
    { id: 'vhs', aliases: ['вхс', 'vhs', 'помехи', 'плёнка'], css: 'fx-vhs', moods: ['corrupt', 'nostalgia', 'eerie'], intensity: 6, scope: 'inline', weight: 1.0, colorBased: false, special: true, reducedMotion: 'fx-vhs-static', desc: 'видеопомехи старой плёнки' },
    { id: 'pixelate', aliases: ['пиксели', 'pixelate', 'мозаика'], css: 'fx-pixelate', moods: ['corrupt', 'chaos', 'cold'], intensity: 6, scope: 'inline', weight: 0.3, colorBased: false, special: true, reducedMotion: 'fx-pixelate-static', desc: 'распадается на пиксели' },
    { id: 'bloom', aliases: ['засветка', 'bloom', 'передержка'], css: 'fx-bloom', moods: ['sacred', 'joy', 'dream'], intensity: 4, scope: 'inline', weight: 1.0, colorBased: true, special: false, reducedMotion: 'fx-bloom-static', desc: 'пересвеченное сияние' },
    { id: 'stretch', aliases: ['растяжение', 'stretch', 'тянется'], css: 'fx-stretch', moods: ['psychedelic', 'chaos', 'dream'], intensity: 6, scope: 'inline', weight: 1.0, colorBased: false, special: false, reducedMotion: 'disable', desc: 'растягивается и сжимается' },
    { id: 'breathe', aliases: ['дыхание', 'breathe', 'дышит'], css: 'fx-breathe', moods: ['calm', 'tender', 'sensual'], intensity: 2, scope: 'inline', weight: 1.0, colorBased: false, special: false, reducedMotion: 'disable', desc: 'медленно дышит' },
    { id: 'dissolve', aliases: ['растворение', 'dissolve', 'исчезает'], css: 'fx-dissolve', moods: ['sorrow', 'dream', 'eerie'], intensity: 5, scope: 'inline', weight: 1.0, colorBased: false, special: true, reducedMotion: 'fx-dissolve-static', desc: 'растворяется в воздухе' },
    { id: 'highlight', aliases: ['маркер', 'highlight', 'выделение'], css: 'fx-highlight', moods: ['joy', 'nostalgia', 'cold'], intensity: 2, scope: 'inline', weight: 1.0, colorBased: false, special: true, reducedMotion: null, desc: 'подчёркнуто маркером' },
    { id: 'stamp', aliases: ['печать', 'stamp', 'оттиск', 'штамп'], css: 'fx-stamp', moods: ['cold', 'ominous'], intensity: 3, scope: 'inline', weight: 0.3, colorBased: false, special: true, reducedMotion: null, desc: 'оттиск печати, наискось' },
    { id: 'blackletter', aliases: ['готика', 'blackletter', 'gothic', 'фрактура'], css: 'fx-blackletter', moods: ['sacred', 'corrupt', 'eerie'], intensity: 3, scope: 'inline', weight: 0.3, colorBased: false, special: false, reducedMotion: null, desc: 'тяжёлое архаичное начертание, как в старой книге' },
    { id: 'spaced', aliases: ['разрядка', 'spaced', 'р а з р я д к а'], css: 'fx-spaced', moods: ['cold', 'eerie', 'calm'], intensity: 2, scope: 'inline', weight: 1.0, colorBased: false, special: false, reducedMotion: null, desc: 'буквы с широкой разрядкой' },
    { id: 'chrome', aliases: ['хром', 'chrome', 'металл'], css: 'fx-chrome', moods: ['cold', 'sacred'], intensity: 4, scope: 'inline', weight: 0.3, colorBased: false, special: true, reducedMotion: 'fx-chrome-static', desc: 'холодный металлический блеск' },
    { id: 'bleed', aliases: ['растекание', 'bleed', 'краска'], css: 'fx-bleed', moods: ['corrupt', 'sorrow', 'rage'], intensity: 5, scope: 'inline', weight: 0.3, colorBased: true, special: false, reducedMotion: 'fx-bleed-static', desc: 'краска растекается по буквам' },
    { id: 'crawl', aliases: ['ползёт', 'crawl', 'шевеление'], css: 'fx-crawl', moods: ['eerie', 'corrupt', 'fear'], intensity: 5, scope: 'inline', weight: 1.0, colorBased: false, special: false, perLetter: true, reducedMotion: 'disable', desc: 'буквы шевелятся вразнобой' },

    { id: 'stairs', aliases: ['лесенка', 'stairs', 'ступени'], css: 'fx-stairs', moods: ['chaos', 'psychedelic', 'dream'], intensity: 6, scope: 'spatial', weight: 0.3, colorBased: false, special: false, perLetter: true, reducedMotion: null, maxChars: 120, desc: 'фраза сползает лесенкой' },
    { id: 'vanish', aliases: ['затухание', 'vanish', 'угасает'], css: 'fx-vanish', moods: ['sorrow', 'eerie', 'dream'], intensity: 5, scope: 'spatial', weight: 1.0, colorBased: false, special: true, perLetter: true, reducedMotion: null, maxChars: 160, desc: 'фраза угасает к концу' },
    { id: 'swell', aliases: ['нарастание', 'swell', 'растёт'], css: 'fx-swell', moods: ['rage', 'chaos', 'sacred'], intensity: 6, scope: 'spatial', weight: 1.0, colorBased: false, special: false, perLetter: true, reducedMotion: null, maxChars: 160, desc: 'фраза нарастает к концу' },
    { id: 'topple', aliases: ['заваливается', 'topple', 'падает'], css: 'fx-topple', moods: ['chaos', 'psychedelic', 'fear'], intensity: 7, scope: 'spatial', weight: 0.3, colorBased: false, special: false, perLetter: true, reducedMotion: null, maxChars: 120, desc: 'фраза заваливается набок' }
  ];
  ...
  var FORMS = [
    ...
    { id: 'dossier', moods: ['ominous', 'cold', 'fear'], intensity: 6, weight: 0.3, css: 'fx-dossier', desc: 'досье с цензурой', instruction: 'Оформи как засекреченный документ в духе SCP: гриф секретности, заголовки, пронумерованные пункты. Засекречивай ОТДЕЛЬНЫЕ слова и факты (имена, числа, термины, классификации), заменяя их на [ДАННЫЕ УДАЛЕНЫ] — только там, где реально стоял бы конкретный факт, а не наугад посреди фразы.' },
