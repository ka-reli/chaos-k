...
- **Ручные описания персонажей для режиссёра** — поле в настройках, куда юзер сам
  вписывает краткие описания персонажей/персоны (напр. «павший бог, притягивает хаос»),
  чтобы режиссёр учитывал их при выборе настроений. Карточки автоматически не тянем.
- **Таймаут вызова режиссёра** — жёсткий лимит ожидания с откатом на текущие
  настройки (пока вызов блокирующий: атмосфера всегда актуальна, задержка ок).
